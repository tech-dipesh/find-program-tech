  ...
  return (
    ...
    <div className="flex flex-col items-center min-h-screen p-4 bg-gray-50">
      <div className="w-full max-w-3xl mx-auto space-y-6 mt-25">
        {tools.length > 0 ? (
          tools.map(tool => (
            <div key={tool._id} className="relative flex flex-col p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="flex items-start gap-4">
                <img 
                  src={tool.logo || Node} 
                  alt="Tool Logo" 
              ...
              <p className="mt-4 text-gray-600 text-md">{tool.Description}</p>
              {/* Include other tool properties here */}
              <div className="mt-6 flex justify-end">
                <button className="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors duration-200">
                  Learn More
                </button>
